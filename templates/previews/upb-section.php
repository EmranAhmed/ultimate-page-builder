...
<div v-show="enabled" :id="addID()" :class="addClass(attributes['background-type']=='gradient'?'gradient':'')" v-preview-element :style="inlineStyle({'--margin-bottom': `${attributes.space}px`})">
