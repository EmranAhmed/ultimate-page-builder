<?php
	...
	if ( ! class_exists( 'UPB_Customize_Setting' ) ):
		class UPB_Customize_Setting extends WP_Customize_Setting {

			const SETTING_ID_PATTERN = '/^upb\[(?P<post_id>\d+)\]\[(?P<meta_key>.+)\]$/';
			 ...
			 */
			static function get_post_meta_setting_id( $post_id, $meta_key ) {
				return sprintf( 'upb[%d][%s]', $post_id, $meta_key );
			}
